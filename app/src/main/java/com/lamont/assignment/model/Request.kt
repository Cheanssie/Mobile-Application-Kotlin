...
data class Request(val requestId: String?, val ownerId:String, val owner: String, val desc: String, val category: String, val imgUri: Uri?, var donorId: String?, val createdDate: String, var status: Int = 1) {
    //username is unique
